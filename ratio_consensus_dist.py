...
#TODO: set up activate file to pipe stdout to some file so manually commenting out the #print statements is not necessary 
...
while t <= tmax:	#NOTE: Have this determined by the input file? Either send tmax with GO flag if inI or have it be some hardcoded param for now?
	...
	while not END_INNER:	
		...
		if isTimer:		#If this der is the timer, send the GO signal
